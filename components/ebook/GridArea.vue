  ...
  <section class="blog__grid grey-bg-4 pt-90 pb-100">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6" v-for="ebook in ebooks.slice(
          ...
          <div class="blog__item-10 white-bg transition-3 mb-30 fix">
            ...
            <div class="blog__content-10">
              <div class="blog__content-10-top">
                ...
                <p>{{ ebook.attributes.shortDesc }}...</p>
              </div>
              <div class="blog__content-10-bottom d-flex align-items-center justify-content-between">
                <div class="blog__meta-author-10 d-flex align-items-center">
                  <div class="blog__meta-author-thumb-10">
                    <a href="#">
                      <img :src="ebook.attributes.avtar.data.attributes.url" alt="avtar">
                    </a>
                  </div>
                  <div class="blog__meta-author-content-10">
                    <span>
                      By <a href="#">{{ ebook.attributes.author }}</a>
                    </span>
                  </div>
                </div>
...
export default {
  ...
  created: async function () {
    const response = await axios.get('https://cms.dotglobaltech.com/api/ebooks?populate=*')
    this.ebooks = response.data.data.sort((b, a) => a.id - b.id);
    this.rows = this.ebooks?.length;
  },
}
</script>