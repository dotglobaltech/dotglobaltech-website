            ...
            <div class="about__list about__list-counter">
              <div class="about__list-item d-flex align-items-start">
                ...
                <div class="about__list-content">
                  <h3 class="about__list-title">One-Stop SAP Destination</h3>
                  <p>
                    We cater to all your SAP needs, from licensing and infrastructure to SAP Training and SAP Support Services, eliminating the need for multiple vendors.
                  </p>
                </div>
              </div>
              <div class="about__list-item d-flex align-items-start">
                ...
                <div class="about__list-content">
                  <h3 class="about__list-title">Industry-Specific Solutions</h3>
                  <p>
                    We go beyond cookie-cutter solutions, tailoring SAP Analytics Cloud to your specific industry's challenges and opportunities.
                  </p>
                </div>
              </div>
              <div class="about__list-item d-flex align-items-start">
                ...
                <div class="about__list-content">
                  <h3 class="about__list-title">Proven Track Record of Success</h3>
                  <p>
                    Our portfolio speaks volumes - we've delivered transformative SAP implementations and integrations for businesses of all sizes.
                 </p>
                </div>
              </div>
              <div class="about__list-item d-flex align-items-start">
                ...
                <div class="about__list-content">
                  ...
                  <p>
                    We're not just consultants - we're your long-term partners, ensuring your digital success every step of the way.
                  </p>
                </div>
              </div>
            </div>
