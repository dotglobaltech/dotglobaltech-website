      ...
      service_data: [
        {
          ...
          title: "Accessibility Anywhere, Anytime",
          subtitle: "Work from anywhere with internet access, eliminating geographical barriers and boosting remote working capabilities.",
        },
        {
          id: 2,
          delay: "150",
          ...
          subtitle: "No more worrying about manual updates or compatibility issues. SAP Cloud automatically updates itself, ensuring you're always using the latest features and security patches.",
        },
        {
          id: 3,
          delay: "170",
          ...
          subtitle: "Scale your infrastructure up or down - based on your changing needs, without the hefty upfront investments of on-premise solutions.",
        },
        {
          id: 4,
          delay: "170",
          ...
          subtitle: "Foster seamless collaboration across departments and locations with real-time data sharing and integrated communication tools.",
        },
        {
          id: 5,
          delay: "170",
          ...
          subtitle: "Gain deeper insights into your data with built-in analytics tools, enabling data-driven decision-making at all levels.",
        },
        {
          id: 6,
          delay: "170",
          ...
          subtitle: "SAP Cloud boasts robust security features and adheres to strict compliance regulations, safeguarding your data and operations.",
        },
        {
          id: 7,
          delay: "170",
          ...
          subtitle: "Access your SAP applications and data from any mobile device, empowering on-the-go productivity.",
        },
      ],
    };
  },
