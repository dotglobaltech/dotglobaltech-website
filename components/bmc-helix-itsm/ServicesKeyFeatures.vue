      ...
      service_data: [
        {
          ...
          title: "Predictive Service Management",
          description: "As the most acclaimed BMC Helix ITSM Third Party Vendor in Bengaluru, we deploy the solution to help you anticipate issues before they arise, automate routine tasks, and empower proactive problem-solving, allowing your IT teams to drive strategic initiatives.",
        },
        {
          ...
          description: "Orchestrate complex processes with ease using a visual interface. Eliminate manual errors and inefficiencies, maximizing throughput and minimizing delays.",
        },
        {
          ...
          description: "Being the best BMC Helix ITSM Consultant, we help you deliver a modern, persona-based interface that caters to user group-specific needs. This intuitive design fosters seamless user interaction and streamlines service delivery.",
        },
        {
          icon: `<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path opacity="0.4" d="M33.2859 12.4C36.434 12.4 38.9859 9.84803 38.9859 6.7C38.9859 3.55198 36.434 1 33.2859 1C30.1379 1 27.5859 3.55198 27.5859 6.7C27.5859 9.84803 30.1379 12.4 33.2859 12.4Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          description: "Empower both IT agents and end-users with centralized access to accurate and up-to-date information. This centralized knowledge base reduces resolution times and improves overall service quality. Being the best BMC Helix ITSM Support Service Provider, we help clients leverage excellent features to achieve greater service management efficiency.",
        },
        {
          icon: `<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path opacity="0.4" d="M33.2859 12.4C36.434 12.4 38.9859 9.84803 38.9859 6.7C38.9859 3.55198 36.434 1 33.2859 1C30.1379 1 27.5859 3.55198 27.5859 6.7C27.5859 9.84803 30.1379 12.4 33.2859 12.4Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          description: "Through intuitive dashboards and reports, you can gain valuable insights from your data. Make data-driven decisions to optimize your IT operations and enhance efficiency.",
        },
      ],
    };
  },
