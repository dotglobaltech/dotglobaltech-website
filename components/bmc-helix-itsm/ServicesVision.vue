      ...
      service_data: [
        {
          ...
          subtitle: "Users can easily submit requests and resolve common IT issues independently through self-service options, while automation streamlines service delivery and frees agents for complex tasks. We take pride in being the most preferred BMC Helix ITSM Third-Party vendor, helping our clients take their service management to new heights.",
        },
        {
          id: 2,
          delay: "150",
          ...
          title: "Productive Service Management",
          subtitle: "Benefit from the proven capabilities of BMC Remedy now with enhanced mobility, scalability, and agility for exceptional IT support that adapts to your needs. As BMC Helix ITSM Vendors, we possess technical expertise and capabilities to help clients get the most out of their investments.",
        },
        {
          id: 3,
          delay: "170",
          ...
          title: "Effective IT Asset Management",
          subtitle: "Gain comprehensive lifecycle management of IT assets, ensuring compliance, optimizing software licenses, and informing strategic IT decisions through better asset data. Leverage automation for streamlined management and improved efficiency.",
        },
        {
          id: 4,
          delay: "170",
          ...
          title: "Intelligent Incident & Problem Management",
          subtitle: "We are the most trusted BMC Helix ITSM Third Party Vendor in India, empowering clients through ground-breaking features of the solution we deploy. AI helps identify recurring incidents, automates tasks, and prioritizes issues, while real-time correlation allows proactive problem-solving.",
        },
        {
          id: 5,
          delay: "170",
          ...
          subtitle: "Drag-and-drop functionality simplifies change requests, automates conflict detection, and streamlines the approval process for smooth implementations.",
        },
        {
          id: 6,
          delay: "170",
          ...
          subtitle: "Gain valuable insights through powerful analytics, customized reports, and clear visualizations for effective data communication.",
        },
      ],
    };
  },
