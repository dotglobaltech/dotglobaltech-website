        ...
        <div class="col-xxl-8 col-xl-8 col-lg-10 col-md-10">
          <div class="section__title-wrapper-7 mb-60 text-center">
            ...
            <h3 class="section__title-7">
              Unlock AWS To Its Fullest Potential with
          ...
          <div class="row justify-content-center">
            <div class="col-xxl-10 col-xl-10 col-lg-11">
              <div class="features__offer text-center mt-20" data-sal="slide-up" data-sal-delay="190"
                data-sal-duration="1000">
                <p>Remember, DGT isn't just a partner - we're your cloud success story waiting to be written. Contact
                  Dot Global Technologies today and let us be your trusted guide on your cloud journey - as the best
                  <strong>Amazon Web Services managed services</strong> provider. We'll help you unlock the full
                  potential of AWS and propel your business to unimaginable heights.
                </p>
              </div>
            </div>
          </div>
      ...
      service_data: [
        {
          ...
          title: "Agility Unleashed",
          subtitle: "Respond to market shifts in real-time, scaling your resources up or down with incredible ease.",
        },
        {
          id: 2,
          delay: "150",
          ...
          subtitle: "Ditch the upfront infrastructure costs and pay only for what you use, finally breaking free from the shackles of traditional IT.",
        },
        {
          id: 3,
          delay: "170",
          ...
          subtitle: "Leverage AWS's robust security infrastructure and best practices, putting your data at ease in a virtual vault.",
        },
        {
          id: 4,
          delay: "170",
          ...
          subtitle: "Dive into a vast ocean of cutting-edge cloud services, fueling your creativity and turning your wildest ideas into reality.",
        },
      ],
    };
  },
