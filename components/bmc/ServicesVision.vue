    ...
    return {
      service_data: [
        ...
        },
        {
          ...
          subtitle: "Deliver exceptional customer service while maintaining a competitive edge.",
        },
        {
          id: 3,
          delay: "170",
          ...
          subtitle: "Gain a complete picture of your IT assets and dependencies for better visibility and control.",
        },
        {
          id: 4,
          delay: "170",
          ...
          title: "BMC TrueSight",
          subtitle: "Proactively address availability and performance issues with AI-powered insights.",
        },
        {
          id: 5,
          delay: "170",
          ...
          title: "BMC Control-M",
          subtitle: "Streamline and automate batch application tasks for increased efficiency.",
        },
        {
          id: 6,
          delay: "170",
          ...
          subtitle: "Create insightful reports with ease, even for non-technical users.",
        },
        {
          id: 7,
          delay: "170",
          ...
          subtitle: "Simplify system management and ensure optimal performance.",
        },
        {
          id: 8,
          delay: "170",
        ...
        },
        {
          ...
          title: "BMC BladeLogic",
          subtitle: "Automate and manage end-user systems for improved IT efficiency.",
        },
      ],
    };
  },
