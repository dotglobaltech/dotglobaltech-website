      ...
      <div class="row justify-content-center">
        <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10">
          <div class="section__title-wrapper-7 mb-60 text-center">
            ...
            <p>As a trusted Salesforce third-party vendor in India, we take pride in offering development, customization, deployment, and support services for the following Salesforce solutions:</p>
          </div>
        </div>
      </div>
      <div class="services__item-wrapper-7">
        ...
        <div class="col-xxl-10 col-xl-10 col-lg-11">
          <div class="features__offer text-center mt-20" data-sal="slide-up" data-sal-delay="190"
            data-sal-duration="1000">
            <span>Experience the Dot Global advantage by</span>
            <p><nuxt-link href="/contact">Contact</nuxt-link> to discuss your Salesforce consulting and deployment needs. Share your requirements and join us, the best<strong> Salesforce third-party vendor in Bengaluru</strong> , to create a better future for your business.
            </p>
          </div>
        </div>
      </div>
      ...
      service_data: [
        {
          ...
          subtitle: "Automate sales processes for seamless operations.",
        },
        {
          id: 2,
          delay: "150",
          ...
          subtitle: "Synchronize customer support for enhanced satisfaction.",
        },
        {
          id: 3,
          delay: "170",
          ...
          subtitle: "Centralize marketing channels for better synchronization.",
        },
        {
          id: 4,
          delay: "190",
          ...
          subtitle: "Foster connections between employees, customers, associates, and the community.",
        },
        {
          id: 5,
          delay: "210",
          ...
          subtitle: "Provide seamless Ecommerce experiences to grow and retain your customer base.",
        },
        {
          id: 6,
          delay: "230",
          ...
          subtitle: "Integrate data from various sources for better business intelligence.",
        },
      ],
    };
  },
