                          ...
                          <div class="row justify-content-center">
                              <div class="col-xxl-8 col-xl-8 col-lg-9">
                                  <div class="section__title-wrapper-7 text-center mb-60">
                                      <h3 class="section__title-7"><span class="section__title-7-highlight">Our Wide
                                              Variety of Products
...
export default {
  ...
  created: async function () {
      const response = await axios.get('https://cms.dotglobaltech.com/api/client?populate=clientSliders.image')
