<template>
  <section class="elements__carousel-area whatwe-bg pt-100 pb-70">
    <div class="container justify-content-top">
      <div class="row">
        <div class="col-xxl-12">
          <div class="tp-section-wrapper-3 mb-30 text-center">
            <h3 class="section__title">What We <span class="section__title-highlight">Do<svg width="220"
                  height="27" viewBox="0 0 220 27" fill="none">
                  <path
              ...
              <p>Bridging the gap between ideas and solutions
              </p>
            </h3>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="elements__carousel p-relative">
            <Carousel ref="detailsSlider" :items-to-show="3" :autoplay="false" :wrap-around="true" :snapAlign="'center'"
              :breakpoints="{
                992: {
                  itemsToShow: 3,
                },
              ...
              <Slide class="elements__carousel-item w-img">
                <div class="service-card-app hoshd">
                  ...
                  <p class="mt20">With more than ten years of industry experience, we offer reliable, scalable, and secure solutions.</p>
                  <nuxt-link href="/software-development" class="mt20 link-prbs">Read More <i
                      class="fas fa fa-arrow-circle-right"></i></nuxt-link>
                </div>
              </Slide>
              ...
              <Slide class="elements__carousel-item w-img">
                <div class="service-card-app hoshd">
                  ...
                  <p class="mt20">Specializing in compliance assessment, automated testing, and comprehensive quality engineering.</p>
                  <nuxt-link href="/testing-qa" class="mt20 link-prbs">Read More <i
                      class="fas fa fa-arrow-circle-right"></i></nuxt-link>
                </div>
              </Slide>
              ...
              <Slide class="elements__carousel-item w-img">
                <div class="service-card-app hoshd">
                  <h4 class="features__title-7"><nuxt-link href="/application-services">Application Services</nuxt-link></h4>
                  <ul class="-service-list">
                    <li> <nuxt-link href="/">UI/UX</nuxt-link> </li>
                    <li> <nuxt-link href="/">PHP</nuxt-link> </li>
                    <li> <nuxt-link href="/">Java</nuxt-link> </li>
                  ...
                  <p class="mt20">As a reliable Application Managed Services Provider, we specialize in managing and supporting</p>
                  <nuxt-link href="/application-services" class="mt20 link-prbs">Read More <i
                      class="fas fa fa-arrow-circle-right"></i></nuxt-link>
                </div>
              </Slide>
              ...
              <Slide class="elements__carousel-item w-img">
                <div class="service-card-app hoshd">
                  ...
                  <p class="mt20">We empower your business by delivering impactful, meticulously crafted user experience</p>
                  <nuxt-link href="/ui-ux-design" class="mt20 link-prbs">Read More <i
                      class="fas fa fa-arrow-circle-right"></i></nuxt-link>
                </div>
              </Slide>
              ...
              <Slide class="elements__carousel-item w-img">
                <div class="service-card-app hoshd">
                  ...
                  <p class="mt20">We engage a team of seasoned and specialized IT professionals for a defined period to conceptualize.</p>
                  <nuxt-link href="/" class="mt20 link-prbs">Read More <i
                      class="fas fa fa-arrow-circle-right"></i></nuxt-link>
                </div>
              </Slide>
              ...
              <Slide class="elements__carousel-item w-img">
                <div class="service-card-app hoshd">
                  ...
                  <p class="mt20">We assist businesses in making informed decisions by transforming historical and real-time data.</p>
                  <nuxt-link href="/data-analytics" class="mt20 link-prbs">Read More <i
                      class="fas fa fa-arrow-circle-right"></i></nuxt-link>
                </div>
              </Slide>
              ...
              <Slide class="elements__carousel-item w-img">
                <div class="service-card-app hoshd">
                  ...
                  <p class="mt20">Professional help desk services tailored for your IT environment or software products.</p>
                  <nuxt-link href="/" class="mt20 link-prbs">Read More <i
                      class="fas fa fa-arrow-circle-right"></i></nuxt-link>
                </div>
              </Slide>
              ...
              <Slide class="elements__carousel-item w-img">
              <div class="service-card-app hoshd">
                  <h4 class="features__title-7"><nuxt-link href="/infrastructure-services">Infrastructure Services</nuxt-link></h4>
                  <ul class="-service-list">
                    <li> <nuxt-link href="/">UI/UX</nuxt-link> </li>
                    <li> <nuxt-link href="/">PHP</nuxt-link> </li>
                    <li> <nuxt-link href="/">Java</nuxt-link> </li>
                  ...
                  <p class="mt20">With over a decade of expertise, we provide a comprehensive range of infrastructure services.</p>
                  <nuxt-link href="/infrastructure-services" class="mt20 link-prbs">Read More <i
                      class="fas fa fa-arrow-circle-right"></i></nuxt-link>
                </div>
              </Slide>
              ...
              <div class="service-card-app hoshd">
                  ...
                  <p class="mt20">With over a decade of expertise in information security and adherence to management best practices</p>
                  <nuxt-link href="/cybersecurity" class="mt20 link-prbs">Read More <i
                      class="fas fa fa-arrow-circle-right"></i></nuxt-link>
                </div>
              </Slide>
            ...
            <div class="elements-arrow">
              <button @click="handlePrev" type="button" class="elements-button-prev slick-prev slick-arrow">
                <i class="fa-solid fa-angle-left"></i>
              </button>
              <button @click="handleNext" type="button" class="elements-button-next slick-next slick-arrow">
