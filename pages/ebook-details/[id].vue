...
import DetailsBreadcrumb from '~~/components/ebook/DetailsBreadcrumb.vue';
import eBookDetails from '~~/components/ebook/eBookDetails.vue';
...
export default {
    ...
    created: async function () {
        ...
        const reaponse = await axios.get(`https://cms.dotglobaltech.com/api/ebooks?filters[slug][$eq]=${slug}&populate=*`, { params: { slug } })
