...
import HomePortfolio from '~~/components/kiosk-software/HomePortfolio.vue';
import ServicesSupportArea from '~~/components/kiosk-software/ServicesSupportArea.vue';
