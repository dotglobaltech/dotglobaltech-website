...
import HomeServices from '~~/components/cloud/HomeServices.vue';
import BMCServicesAbout from '~~/components/cloud/BMCServicesAbout.vue';
import ServicesVision from '~~/components/cloud/ServicesVision.vue';
import HomePortfolio from '~~/components/cloud/HomePortfolio.vue';
import ServicesSupportArea from '~~/components/cloud/ServicesSupportArea.vue';
