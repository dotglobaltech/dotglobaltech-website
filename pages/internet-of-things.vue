...
import HomePortfolio from '~~/components/internet-of-things/HomePortfolio.vue';
import ServicesSupportArea from '~~/components/internet-of-things/ServicesSupportArea.vue';
