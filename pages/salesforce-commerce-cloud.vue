...
import HomePortfolio from '~~/components/salesforce-commerce-cloud/HomePortfolio.vue';
import ServicesSupportArea from '~~/components/salesforce-commerce-cloud/ServicesSupportArea.vue';
