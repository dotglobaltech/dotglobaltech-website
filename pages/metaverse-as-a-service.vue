...
import HomePortfolio from '~~/components/metaverse-as-a-service/HomePortfolio.vue';
import ServicesSupportArea from '~~/components/metaverse-as-a-service/ServicesSupportArea.vue';
