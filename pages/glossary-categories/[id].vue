<template>
  ...
  <Breadcrumb title="Glossary Categories" subtitle="Glossary Categories" />
  <div>
...
import Breadcrumb from '~~/components/glossary/Breadcrumb.vue';
import CategoryGridContents from '~~/components/glossary/CategoryGridContents.vue';
  ...
  methods: {
    async fetchCategories() {
      try {
        ...
        const reaponse = await axios.get(`https://cms.dotglobaltech.com/api/glossary-categories?filters[slug][$eq]=${slug}&populate=deep,5`, { params: { slug } })
