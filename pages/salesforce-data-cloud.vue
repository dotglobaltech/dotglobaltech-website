...
import HomeServices from '~~/components/salesforce-data-cloud/HomeServices.vue';
import BMCServicesAbout from '~~/components/salesforce-data-cloud/BMCServicesAbout.vue';
import ServicesVision from '~~/components/salesforce-data-cloud/ServicesVision.vue';
import HomePortfolio from '~~/components/salesforce-data-cloud/HomePortfolio.vue';
import ServicesSupportArea from '~~/components/salesforce-data-cloud/ServicesSupportArea.vue';
