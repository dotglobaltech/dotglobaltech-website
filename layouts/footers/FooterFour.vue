<template>
  <footer>
    <div :class="`footer__area ${style_2 ? 'footer__style-3' : ''}`"
      :data-bg-color="`footer-bg-${style_2 ? 'grey-4' : 'white'}`">
          ...
          <div class="row">
            ...
            <div class="col-xxl-2 col-xl-2 col-lg-7 col-md-6 ">
              <div class="footer__widget footer__widget-5">
                ...
                <div class="footer__widget-content">
                  <ul>
                    <li><nuxt-link href="/coming-soon">What We Do</nuxt-link></li>
                    <li><nuxt-link href="/coming-soon">Offering</nuxt-link></li>
                    <li><nuxt-link href="/coming-soon">Innovation</nuxt-link></li>
                    <li><nuxt-link href="/coming-soon">Staff Augmentation</nuxt-link></li>
                    <li><nuxt-link href="/coming-soon">Company</nuxt-link></li>
                  </ul>
                </div>
              </div>
            </div>
            <div class="col-xxl-3 col-xl-3 col-lg-7 col-md-6 ">
              <div class="footer__widget footer__widget-5">
                ...
                <div class="footer__widget-content">
                  <ul>
                    <li><nuxt-link href="/coming-soon">Unity 3D</nuxt-link></li>
                    <li><nuxt-link href="/coming-soon">Unreal Engine</nuxt-link></li>
                    <li><nuxt-link href="/coming-soon">Augmented Reality</nuxt-link></li>
                    <li><nuxt-link href="/coming-soon">Casual Games</nuxt-link></li>
                    <li><nuxt-link href="/coming-soon">Metaverse</nuxt-link></li>
                  </ul>
                </div>
              </div>
            </div>
                  ...
                  <div class="footer__info">
                    <div class="footer__info-item d-flex align-items-start">
                      ...
                      <div class="footer__info-text">
                        <h4>Call us:</h4>
                        <a href="tel:+91-9606028218">+91-9606028218</a>
                      </div>
                    </div>
                    <div class="footer__info-item d-flex align-items-start">
                      <div class="footer__info-icon mr-20">
                    ...
                    <div class="footer__info-item d-flex align-items-start">
                      ...
                      <div class="footer__info-text">
                        <h4>Office:</h4>
                        <a target="_blank" href="/">HBR Layout, Bengaluru, Karnataka 560043.</a>
                      </div>
                    </div>
                  </div>
                </div>
