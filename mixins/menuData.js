...

        {
          ...
          mega_menus: [
            ...
            },
            {
              ...
              link: "#",
              submenus: [
                { title: "Financial Services", link: "/software-development" },
                { title: "Banking", link: "/web-development" },
                { title: "Insurance", link: "/mobile-app-development" },
                { title: "Lendin", link: "/testing-qa" },
                { title: "Investment", link: "/application-services" },
                { title: "Fintech", link: "/ui-ux-design" },
                { title: "Payments", link: "/infrastructure-services" },
                { title: "Retail", link: "/digital-transformation" },
                { title: "Healthcare", link: "/managed-it-services" },
                { title: "Manufacturing", link: "/it-outsourcing" },
                { title: "Professional Services", link: "/it-consulting" },
                { title: "Transportation and Logistics", link: "/it-support" },
                { title: "Telecommunications", link: "/data-analytics" },
                { title: "Oil and Gas", link: "/cybersecurity" },
                { title: "Construction", link: "/cybersecurity" },
                { title: "Travel and Hospitality", link: "/cybersecurity" },
